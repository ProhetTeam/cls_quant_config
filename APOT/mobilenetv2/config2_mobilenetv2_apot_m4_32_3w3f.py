...
quant_transformer = dict(
    ...
    quan_policy=dict(
        Conv2d=dict(type='APOTQuantConv2d', bit_w=3, bit_a=3, power=True),
        Linear = dict(
...
# optimizer
num_nodes = 3
optimizer = dict(type='SGD', lr=1e-2 * num_nodes, momentum=0.9, weight_decay=0.0001)
...
work_dir = '/data/work_dirs/APOT/config3_mobilenetv2_apot_m4_3w3f_new'
workflow = [('train', 1)]

load_from = '/data/work_dirs/APOT/config3_mobilenetv2_apot_m4_4w4f_new/latest.pth'
resume_from = None 
cpu_only=True
