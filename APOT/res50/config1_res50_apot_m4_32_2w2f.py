...
quant_transformer = dict(
    ...
    quan_policy=dict(
        Conv2d=dict(type='APOTQuantConv2d', bit_w=2, bit_a=),
        Linear = dict(
...
work_dir = '/data/work_dirs/APOT/res50/config1_res50_lsq_m2_64_2w2f'
workflow = [('train', 1)]

load_from = '/data/work_dirs/APOT/res50/config2_res50_lsq_m2_64_3w3f/latest.pth'
resume_from = ''
cpu_only=True
