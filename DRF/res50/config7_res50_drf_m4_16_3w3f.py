...
# optimizer
num_nodes = 4
optimizer = dict(type='SGD', lr=0.002 * num_nodes, momentum=0.9, weight_decay=0.0001)
...
work_dir = '/data/workspace/lowbit_classification/workdirs/DRF/res50/config7_res50_drf_m4_16_3w3f'
workflow = [('train', 1)]
load_from = None
resume_from = '/data/workspace/lowbit_classification/workdirs/DRF/res50/config7_res50_drf_m4_16_3w3f/latest.pth'
# resume_from = None
cpu_only=False
