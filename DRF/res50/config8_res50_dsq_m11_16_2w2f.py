...
quant_transformer = dict(
    ...
    quan_policy=dict(
        Conv2d=dict(type='DSQConv', num_bit_w=2, num_bit_a=2, bSetQ=True),
        Linear=dict(type='DSQLinear', num_bit_w=2, num_bit_a=2)
        ),
    special_layers = dict(
        layers_name = [
            'backbone.conv1',
...
# optimizer
num_nodes = 11
optimizer = dict(type='SGD', lr=0.0005 * num_nodes, momentum=0.9, weight_decay=0.0001)
...
work_dir = '/data/workspace/lowbit_classification/workdirs/DSQ/res50/config8_res50_dsq_m11_16_2w2f'
workflow = [('train', 1)]
load_from = '/data/workspace/lowbit_classification/workdirs/DSQ/res50/config7_res50_dsq_m9_16_3w3f/epoch_65.pth'
resume_from = None
cpu_only=False
