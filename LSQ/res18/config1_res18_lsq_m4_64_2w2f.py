...
quant_transformer = dict(
    ...
    quan_policy=dict(
        Conv2d=dict(type='LSQConv2d', nbits_w=4, nbits_a=4),
        Linear=dict(type='LSQLinear', nbits_w=4, nbits_a=4)
        ),
    special_layers = dict(
        layers_name = [
            'backbone.conv1',
...
work_dir = 'data/work_dirs/test/LSQ/res18/config2_res18_lsq_m4_64_4w4f'
workflow = [('train', 1)]

load_from = '/home/likeyu/lowbit_classification/thirdparty/modelzoo/res18.pth'
resume_from = None
cpu_only=False
