...
quant_transformer = dict(
    ...
    quan_policy=dict(
        Conv2d=dict(type='LSQConv2d', nbits_w=3, nbits_a=3),
        Linear=dict(type='LSQLinear', nbits_w=3, nbits_a=3)
        ),
    special_layers = dict(
        layers_name = [
            'backbone.conv1',
...
work_dir = '/data/work_dirs/LSQ/res50/config2_res50_lsq_m4_32_3w3f'
workflow = [('train', 1)]

load_from = './work_dir/LSQ/res50/config3_res50_lsq_m4_32_4w4f/epoch_120.pth'
resume_from = None
cpu_only=True
