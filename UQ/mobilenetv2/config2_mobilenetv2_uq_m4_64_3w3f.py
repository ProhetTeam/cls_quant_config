...
# optimizer
num_nodes = 3
optimizer = dict(type='SGD', lr=1e-3 * num_nodes, momentum=0.9, weight_decay=0.0001)
...
work_dir = '/data/work_dirs/UQ/mobilenet/config2_mobilenetv2_uq_m4_32_3w3f'
workflow = [('train', 1)]

load_from = '/data/work_dirs/UniformQuant/mobilenet/mobilenet_4w4f.pth'
resume_from = ''
cpu_only=True
