...
quant_transformer = dict(
    ...
    quan_policy=dict(
        Conv2d=dict(type='APOTQuantConv2d', bit_w=3, bit_a=3, power=False),
        Linear=dict(type='APOTQuantLinear', bit_w=3, bit_a=3, power=False)
        ),
    special_layers = dict(
        layers_name = [
            'backbone.conv1',
...
work_dir = '/data/work_dirs/UniformQuant/res18/config3_res18_UQ_m2_128_w3f3'

workflow = [('train', 1)]

load_from = './work_dirs/UniformQuant/config2_res18_UQ_m2_128_w4f4/latest.pth'
resume_from = '/data/work_dirs/UniformQuant/res18/config3_res18_UQ_m2_128_w3f3/latest.pth' 
